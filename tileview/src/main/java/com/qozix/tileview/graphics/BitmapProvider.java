 ...
 * like column and row numbers), the arbitrary data object passed for the detail level (which
 * can be anything), and a Context instance to help with things like file i/o - as long as the
