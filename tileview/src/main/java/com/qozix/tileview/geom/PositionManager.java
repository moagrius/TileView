...
public class PositionManager {
  ...
  public void setSize( int w, int h ) {
    pixelWidth = w;
    pixelHeight = h;
    if( !definedBounds ) {  // TODO: shouldn't left and right be set here
      right = pixelWidth;
      bottom = pixelHeight;
      calculateOffsets();
    }
  ...
  // get back the point coordinates *not* scaled (for markers, callouts, etc, that handle mScale internally)
